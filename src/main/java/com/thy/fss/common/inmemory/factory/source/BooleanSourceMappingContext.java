...
/**
 * Specialized source mapping context for Boolean target fields.
 * Overrides value() to validate that the source field is also a Boolean type.
 * 
 * <p>This context is returned when mapping from a source to a Boolean target field.
 ...
 */
public class BooleanSourceMappingContext<R, S>
        extends SourceMappingContext<R, Boolean, S> {
    
    /**
     * Public constructor for creating boolean source mapping context.
     * 
     ...
     */
    public BooleanSourceMappingContext(
            PropertyNavigationContext<R, Boolean> targetContext,
    ...
    /**
     * Complete mapping as single value mapping with Boolean type validation.
     * Maps a single source field value to the target field.
     * The source field must be a Boolean type.
     * Returns to root builder.
     * 
     * @param sourceFieldBuilder function to select source field (must return Boolean field)
     * @return root builder for defining additional mappings
     * @throws NullPointerException if sourceFieldBuilder is null
     * @throws IllegalArgumentException if source field is not a Boolean type
     */
    @Override
    public AbstractRootBuilder<R> value(
        ...
        validateSourceFieldType(sourcePath, Boolean.class, "value");
