...
public final class MappingApplicator {
    ...
    public static void applyCollectionMapping(
        ...
        // Assign collected values to target — the centralized discriminator in
        // BaseSpecificationService.assignToCollectionField handles flat assignment
        // (clear+addAll) for collection-to-collection and preserves concrete type (List/Set).
