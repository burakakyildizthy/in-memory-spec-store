...
//        }
    ...
    private void generateSetValueByPathWithCollections(PrintWriter out, String simpleClassName) {
        ...
        out.println("                // ALL selector: delegate to shared discriminator for flat + idempotent assignment");
        out.println("                // (collection.add(value) would incorrectly wrap entire source collections as a single element)");
        out.println("                assignToCollectionField(currentValue, lastAttribute, value, service);");
        out.println("            } else {");
