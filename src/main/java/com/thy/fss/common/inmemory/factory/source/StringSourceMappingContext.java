...
/**
 * Specialized source mapping context for String target fields.
 * Overrides value() to validate that the source field is also a String type.
 * 
 * <p>This context is returned when mapping from a source to a String target field.
 ...
 */
public class StringSourceMappingContext<R, S>
        extends SourceMappingContext<R, String, S> {
    
    /**
     * Public constructor for creating string source mapping context.
     * 
     ...
     */
    public StringSourceMappingContext(
            PropertyNavigationContext<R, String> targetContext,
    ...
    /**
     * Complete mapping as single value mapping with String type validation.
     * Maps a single source field value to the target field.
     * The source field must be a String type.
     * Returns to root builder.
     * 
     * @param sourceFieldBuilder function to select source field (must return String field)
     * @return root builder for defining additional mappings
     * @throws NullPointerException if sourceFieldBuilder is null
     * @throws IllegalArgumentException if source field is not a String type
     */
    @Override
    public AbstractRootBuilder<R> value(
        ...
        validateSourceFieldType(sourcePath, String.class, "value");
